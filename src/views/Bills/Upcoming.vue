            ...
            <div slot="header" class="bg-white border-0">
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                  <img src="img/brand/asiahawala.png" />
                </div>
              </div>
            </div>
            <template>
              <form @submit.prevent>
                ...
                <div class="pl-lg-4">
                  <div class="row mt-4">
                    <base-input label="Date" class="col-2">
                      <flat-picker
                        readonly
                    ...
                    <base-input label="Due Date" class="col-2">
                      <flat-picker
                        readonly
                        slot-scope="{focus, blur}"
                        @on-open="focus"
  ...
  data() {
    return {
      ...
      model: {
        ...
        // lines
        lines: [
          { description: "Pen", price: 500, quantity: 5 },
          { description: "Book", price: 1000, quantity: 2 },
          { description: "Notebook", price: 1500, quantity: 3 }
        ]
      }
    };
  },
